...
export async function LongformMarketplacePage({ page }: { page: LongformPage }) {
  ...
  return <main>
    ...
    <section className="border-b"><div className="mx-auto max-w-6xl px-4 py-14 sm:px-6"><h2 className="text-2xl font-semibold">Frequently asked questions</h2><FaqGrid items={FAQS} className="mt-6" /></div></section>
