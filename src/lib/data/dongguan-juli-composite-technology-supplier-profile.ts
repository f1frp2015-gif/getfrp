...
// current official logo image was served through a third-party CDN that returned
// HTTP 567 to direct download and rendered broken in a clean browser on
// 2026-08-25, so the profile intentionally uses the text fallback.
