...
// plus the 2026 CCE directory. The complete official header logo was downloaded
// on 2026-08-26 from the exact OMO asset referenced by the current page:
// https://omo-oss-image.thefastimg.com/portal-saas/pg2024112918161546739/cms/image/c3643cf6-8264-4bc5-bb6a-a9139353c77b.png
export const JIANGSU_AULLAND_FRP_SUPPLIER_PROFILE: SupplierListing = {
  ...
  descriptionEn:
    "Jiangsu Aulland New Material Technology Co., Ltd. is a Nantong supplier of FRP grating, pultruded fiberglass profiles and access structures. Its current official product pages and the 2026 China Composites Expo directory support molded grating, pultruded grating, phenolic grating, micromesh and covered panels, I- and H-beams, flat bars, tubes, kick plates, handrails, stair treads, ladders and custom sections. GetFRP therefore assigns measured-demand phrases including fiberglass grating, FRP grating, fiberglass pultruded grating, molded FRP grating and pultruded fiberglass to explicit offers. Hand lay-up or pultrusion capability is not expanded into pipe, sheet or rebar products that the reviewed catalog did not publish. The English subdomain was intermittently unavailable during review, while the official Chinese domain remained accessible. The complete current logo was downloaded on 2026-08-26 from the exact OMO asset referenced by the official header, trimmed only to remove transparent canvas, and stored locally by GetFRP. ASTM E84, ABS and ISO 9001 references remain company claims because certificate files aligned to the legal entity, address, scope, number and validity date were not verified.",
  certifications: [],
  certificationsEn: [],
  productsServicesSummary:
    "澳兰德产品目录的核心是模塑和拉挤两类格栅，以及围绕工业平台、通道、楼梯和防腐结构的拉挤型材。模塑格栅 RFQ 应明确树脂体系、阻燃/低烟或酚醛要求、网格尺寸、整板尺寸、厚度、承载方向、玻纤含量、表面形式、颜色、紫外稳定、跨距、集中/均布载荷、挠度限值、切边封闭和夹具；微孔、铺砂、凹面和覆板结构不能互换。拉挤格栅和 I 梁、H 梁、平板条、方管、扁管、踢脚板等型材应给出截面图、长度、公差、直线度、树脂、玻纤粗纱/毡结构、表面毡、力学性能、玻璃化温度、耐腐蚀介质、火焰性能和加工孔位。扶手、楼梯、踏步和爬梯项目还需提交平台布置、节点、连接件材质、护栏高度、踢脚板、载荷组合、现场切割限制和安装责任。定制异型材应在模具前冻结关键尺寸、脱模斜度、壁厚、圆角、表面质量、首件和模具所有权。官网展示 ASTM E84、ABS、ISO 9001、规模和出口比例等宣传信息，但未在本轮形成可逐项验证的证书链，买方应索取原件并核对持证法人、地址、产品范围、测试方法、样品厚度和有效期。英文子域偶发关闭连接，中文官网仍可访问；官网完整 Logo 已于 2026-08-26 从页面实际引用的 OMO 资源下载，裁除透明画布后存储在 GetFRP 本地，不再热链第三方资源。报价前应同时确认最小订单、模具费、样品周期、批量交期、包装、托盘、集装箱装载、Incoterms、目的港文件及售后补件。",
  productsServicesSummaryEn:
    "Aulland's reviewed catalog is centered on molded and pultruded grating plus pultruded members for industrial platforms, walkways, stairs and corrosion-resistant structures. A molded-grating RFQ should define resin family, flame or low-smoke requirement, whether a phenolic system is required, mesh, panel size, thickness, load direction, glass content, surface, color, UV stabilization, span, point and distributed loads, deflection limit, sealed cut edges and hold-down clips. Micromesh, gritted, concave and solid-covered constructions are not interchangeable. Pultruded grating and I-beam, H-beam, flat-bar, square-tube, flat-tube and kick-plate inquiries need cross-section drawings, cut length, tolerances, straightness, resin, roving and mat architecture, surface veil, mechanical properties, Tg, chemical exposure, fire behavior and drilled-hole locations. Handrail, stair-tread and ladder projects should add platform layout, connection details, fastener material, rail height, kick plate, load combinations, site-cut restrictions and installation responsibility. A custom profile needs its critical dimensions, draft, wall thickness, radii, cosmetic surface, first-article plan and tool ownership frozen before the die is released. The official site displays ASTM E84, ABS, ISO 9001, scale and export-ratio claims, but this review did not establish a certificate chain for each statement. Buyers should request original files and verify holder, legal address, product scope, test method, specimen thickness and validity date. The English subdomain intermittently closed connections while the Chinese official site remained accessible. Its complete logo was downloaded on 2026-08-26 from the exact OMO asset referenced by the official page, trimmed only to remove transparent canvas, and stored locally rather than hotlinked. Before award, confirm MOQ, tool charge, sample timing, production lead time, packing, pallets, container loading, Incoterms, destination documents and replacement-part support.",
  ecatalogs: [
  ...
  logo: "/supplier-assets/jiangsu-aulland-logo.png",
