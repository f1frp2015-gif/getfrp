...
// The official CDN returned HTTP 403 to direct downloads and blocked direct
// image navigation, so no unverifiable copy is stored; the profile deliberately
// uses its text fallback.
