...
export const PRODUCT_SEARCH_INTENTS: Record<string, ProductSearchIntent> = {
  ...
  "frp-tank": {
    title: "FRP Storage Tanks & Chemical Process Vessels | GetFRP",
    h1: "FRP Storage Tanks, Process Vessels & Scrubbers",
    primaryTerms: ["FRP tanks", "GRP tanks", "fiberglass chemical tanks"],
    audienceNote: "Chemical storage, process vessels, scrubbers and corrosion equipment",
  },
  "frp-manhole-cover": {
    title: "FRP Manhole Covers — Composite Frames & Utility Vaults | GetFRP",
    h1: "FRP Manhole Covers & Heavy-Duty Composite Frames",
  ...
  "frp-duct": {
    title: "FRP Duct Systems — Industrial Ventilation & Scrubbers | GetFRP",
    h1: "FRP Duct Systems & Corrosion-Resistant Ventilation",
    primaryTerms: ["FRP ductwork", "fiberglass ventilation ducts", "chemical scrubber duct"],
    audienceNote: "Industrial exhaust, fume handling, scrubber ductwork and chemical ventilation",
  },
  "fiberglass-molds": {
    title: "Fiberglass Molds & Composite Production Tooling | GetFRP",
    h1: "Fiberglass Molds & Precision Composite Tooling",
    primaryTerms: ["fiberglass molds", "composite tooling", "CNC master plugs"],
    audienceNote: "Master models, composite production molds, infusion tools and matched dies",
  },
  "chopper-gun": {
    title: "Fiberglass Chopper Guns & Spray-up Roving Cutters | GetFRP",
    h1: "Fiberglass Chopper Guns & Spray-up Roving Cutters",
    primaryTerms: ["fiberglass chopper gun", "spray-up cutter", "pneumatic roving chopper"],
    audienceNote: "Open mold spray-up deposition, roving chopping and external mix resin dispensers",
  },
  "gelcoat-spray-gun": {
    title: "Gelcoat Spray Guns & High-Pressure Fluid Dispensers | GetFRP",
    h1: "Gelcoat Spray Guns & Fluid Application Equipment",
    primaryTerms: ["gelcoat spray gun", "air-assisted airless gelcoat gun", "cup spray gun"],
    audienceNote: "Surface gelcoat application, catalyst slave pumping and air-assisted airless guns",
  },
  "curing-oven": {
    title: "Composite Curing Ovens & Thermal Post-Cure Chambers | GetFRP",
    h1: "Composite Curing Ovens & Thermal Post-Curing Chambers",
    primaryTerms: ["composite curing oven", "post-cure oven", "walk-in composite oven"],
    audienceNote: "Elevated temperature curing, multi-zone airflow and post-cure thermal chambers",
  },
  "frp-handrail": {
